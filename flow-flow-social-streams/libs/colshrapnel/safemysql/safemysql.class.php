...
class SafeMySQL
{
	...
	function __construct($opt = array())
	{
		...
		if ( !$this->conn )
		{
			// phpcs:ignore WordPress.DB.RestrictedFunctions.mysql_mysqli_connect_errno, WordPress.DB.RestrictedFunctions.mysql_mysqli_connect_error
			$this->error(mysqli_connect_errno()." ".mysqli_connect_error());
		}

		// phpcs:ignore WordPress.DB.RestrictedFunctions.mysql_mysqli_set_charset, WordPress.DB.RestrictedFunctions.mysql_mysqli_error
	...
	{
		// phpcs:ignore WordPress.DB.RestrictedFunctions.mysql_mysqli_affected_rows
	...
	{
		// phpcs:ignore WordPress.DB.RestrictedFunctions.mysql_mysqli_insert_id
	...
	{
		// phpcs:ignore WordPress.DB.RestrictedFunctions.mysql_mysqli_num_rows
